...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bottom_content: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    top_content: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPhotoshootProjectPhotoshootProject
  ...
  info: {
    description: '';
    displayName: 'Photoshoot Project';
    pluralName: 'photoshoot-projects';
    singularName: 'photoshoot-project';
  };
  options: {
    draftAndPublish: true;
  };
